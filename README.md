...
---
## 🧾 **Veri Üretimi & Veri Yükleme Süreci**

Organik Pazar projesi, gerçek dünyadaki büyük ölçekli veri setlerini simüle edecek şekilde hazırlanmıştır.  
Tüm veriler **ChatGPT**, **Python** ve **CSV otomasyonları** kullanılarak oluşturulmuş, ardından **PostgreSQL** veritabanına aktarılmıştır.

| Veri Türü | Açıklama | Kayıt Sayısı | Üretim Yöntemi |
|------------|-----------|--------------|----------------|
| 🥕 **Ürünler (Products)** | Meyve, sebze, içecek, tatlı, kahvaltılık, atıştırmalık gibi yalnızca **yiyecek kategorisindeki** ürünler. | **250 satır** | ChatGPT destekli `INSERT INTO product (...) VALUES (...)` sorguları |
| 👤 **Müşteriler (Customers)** | Türkçe isim, şehir, adres, telefon, e-posta ve bakiye bilgilerini içeren örnek müşteri verileri. | **500 kayıt** | ChatGPT ile dinamik müşteri veri üretimi |
...
### 🧠 AI API (Gemini) ile Tarif Öneri Sistemi
